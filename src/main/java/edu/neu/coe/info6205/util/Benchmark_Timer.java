...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    public static void main(String[] args)
    {
        ...
        Benchmark_Timer<Integer[]> benchmarkTimer=new Benchmark_Timer<>
                ("Doing the Benchmark",null,(i)->insertionSort.sort(i,0,i.length),null);
        System.out.println("------------------------------------------------------------------------------------------");
        System.out.println("-------------------------------PARTIALLY ORDERED ARRAY------------------------------------");
        System.out.println("------------------------------------------------------------------------------------------");
        for(int n=100;n<=8000;n*=2)
        {
            int m=n;
            ...
            double time=benchmarkTimer.runFromSupplier(supplier,15);
            System.out.println("For " + n + " element partially ordered array,InsertionSort takes: " + time+"ms");
        }
        ...
        for(int n=100;n<=8000;n*=2)
        {
            ...
            Supplier<Integer[]> supplier=new Supplier<Integer[]>() {
                ...
                public Integer[] get() {
                    ...
                    Integer array[]=new Integer[m];
                    for(int k=0; k<m;k++) {
                        array[k] = random.nextInt(1000);
                    }
                    return array;
                }
            };
            double time=benchmarkTimer.runFromSupplier(supplier,15);
            System.out.println("For " + n + " element random ordered array,InsertionSort takes: " + time+"ms");
        }
        ...
        for(int n=100;n<=8000;n*=2)
        {
            ...
            double time=benchmarkTimer.runFromSupplier(supplier,15);
            System.out.println("For " + n + " element ordered array,InsertionSort takes: " + time+"ms");
        }
        ...
        for(int n=100;n<=8000;n*=2)
        {
            ...
            double time=benchmarkTimer.runFromSupplier(supplier,15);
            System.out.println("For " + n + " element reverse ordered array,InsertionSort takes: " + time+"ms");
        }
